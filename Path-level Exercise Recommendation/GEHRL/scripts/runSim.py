...
def main():
    ...
    parser.add_argument('--graph_embedding_input', type=str2bool, default=True)
    ...
    parser.add_argument('--HRL_random_low_level', type=str2bool, default=False)
    parser.add_argument('--HRL_asynchronous_train', type=str2bool, default=True)
