...
def build_graph(base_data_path, graph_type, concept_num, KT_graph_path=None, model_type='GKT'):
    ...
    print(graph)
    np.save(f'{get_proj_path()}/data/dataProcess/{dataset}/MyTransitionGraph.npy',graph)
...
if __name__ == '__main__':
    ...
    base_data_path = f'{get_proj_path()}/data/dataProcess/{dataset}/student_log_kt_None'
    build_graph(base_data_path, 'Transition',num_skills)
    

    graph = np.load(f'{get_proj_path()}/data/dataProcess/{dataset}/MyTransitionGraph.npy')
    ...
    with open(f"{get_proj_path()}/data/dataProcess/{dataset}/nxgraph.pkl", "wb") as file:
    ...
    prerequisite_json_path = f"{get_proj_path()}/data/dataProcess/{dataset}/prerequisite.json"
