...
if __name__ == '__main__':
    ...
    envKESASSIST09: KESASSIST09Env = gym.make('KESASSIST09-v1', dataRec_path=dataRecPath)
    ...
    if len(graph.nodes) == 10:
        ...
        model_save_file_path = f'{get_proj_path()}/EduSim/Envs/meta_data/KSSwvModel.pt'
        embedding_save_file_path = f'{get_proj_path()}/EduSim/Envs/meta_data/KSSGraphEmbedding.pt'
        np_save_path = f'{get_proj_path()}/EduSim/Envs/meta_data/KSSGraphEmbedding.npy'
        ...
        model_save_file_path = f'{get_proj_path()}/EduSim/Envs/meta_data/ASSISTwvModel.pt'
        embedding_save_file_path = f'{get_proj_path()}/EduSim/Envs/meta_data/ASSISTGraphEmbedding.pt'
        ...
        model_save_file_path = f'{get_proj_path()}/EduSim/Envs/meta_data/junyiwvModel.pt'
        embedding_save_file_path = f'{get_proj_path()}/EduSim/Envs/meta_data/junyiGraphEmbedding.pt'
        np_save_path = f'{get_proj_path()}/EduSim/Envs/meta_data/junyiGraphEmbedding.npy'
    elif len(graph.nodes) == 167:
        walk_length = 100
        number_walks = 100
        emb_size = 80
        window_size = 5

        model_save_file_path = f'{get_proj_path()}/EduSim/Envs/meta_data/ASSIST09wvModel.pt'
        embedding_save_file_path = f'{get_proj_path()}/EduSim/Envs/meta_data/ASSIST09GraphEmbedding.pt'
        np_save_path = f'{get_proj_path()}/EduSim/Envs/meta_data/ASSIST09GraphEmbedding.npy'
    else:
    ...
    if not test_flag:
        ...
        model_w2v = Word2Vec(sentences=total_walks, sg=0, hs=0, vector_size=emb_size,
                             window=window_size, min_count=0, workers=1, epochs=10, seed=42)

        model_w2v.save(model_save_file_path)
        model_w2v.wv.save_word2vec_format(embedding_save_file_path)
