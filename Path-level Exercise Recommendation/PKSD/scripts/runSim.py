...
def main():
    ...
    parser.add_argument('-RC', '--Repe_control', type=str2bool, default=True)
    ...
    parser.add_argument('-p1ol', '--PFD_phase_1_only', type=str2bool, default=False)
    parser.add_argument('-ppr', '--PFD_privileged_reward', type=str2bool, default=False)
    parser.add_argument('--PFD_imper_reg_only', type=str2bool, default=False)
