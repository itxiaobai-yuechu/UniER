...
import numpy as np
from EduSim.Envs.KES_bridge2006.meta.Learner import LearnerGroup, Learner
...
__all__ = ["KESbridge2006Env"]


class KESbridge2006Env(Env):
    def __init__(self, dataRec_path, seed=None, cudaDevice=None):
        super().__init__()
        self.target_type = 'portion'
        self.type = 'KES'
        self.env_name = 'KESbridge2006'
        self.random_state = np.random.RandomState(seed)
        self.graph_embeddings = get_graph_embeddings('KES_bridge2006')
        self.dataRec_path = dataRec_path

        self.knowledge_structure = nx.DiGraph()
        with open(f"{get_proj_path()}/data/dataProcess/bridge2006/nxgraph.pkl", "rb") as file:
        ...
        directory = f'{get_proj_path()}/EduSim/Envs/KES_bridge2006/meta_data'
