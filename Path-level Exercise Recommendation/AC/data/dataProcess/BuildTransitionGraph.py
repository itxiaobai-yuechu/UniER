...
from EduSim.Envs.agent_utils import get_raw_data_path
...
if __name__ == '__main__':
    ...
    with open(f"{get_raw_data_path()}/dataProcess/{dataset}/nxgraph.pkl", "wb") as file:
    ...
    prerequisite_json_path = f"{get_raw_data_path()}/dataProcess/{dataset}/prerequisite.json"
