...
def main():
    ...
    simulator = ['KSS', 'KESjunyi', 'KESassist15', 'KESassist09','KESassist12','KESassist17','KESalgebra2005','KESbridge2006','KESnips34','KESednet','KESxes3g5m','KESmooccube']
    agent = ['CSEAL']
    seeds = [1, 5, 10]
    ...
    parser.add_argument('-a', '--agent', type=str, choices=agent, default='CSEAL')
    ...
    parser.add_argument('--cudaDevice', type=str, default='cuda:1')
    ...
    if args['simulator'] == 'KESjunyi':
        ...
        args['dataRecPath'] = f'{get_proj_path()}/data/dataProcess/mooccube/dataRec'
    elif args['simulator'] == 'KESxes3g5m':
        args['dataRecPath'] = f'{get_proj_path()}/data/dataProcess/xes3g5m/dataRec'


    if args['agent'] in RepeControAgents:
