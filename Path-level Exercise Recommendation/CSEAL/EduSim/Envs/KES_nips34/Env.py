...
import numpy as np
from EduSim.Envs.KES_nips34.meta.Learner import LearnerGroup, Learner
...
__all__ = ["KESnips34Env"]


class KESnips34Env(Env):
    def __init__(self, dataRec_path, seed=None, cudaDevice=None):
        super().__init__()
        self.target_type = 'portion'
        self.type = 'KES'
        self.env_name = 'KESnips34'
        self.random_state = np.random.RandomState(seed)
        self.graph_embeddings = get_graph_embeddings('KES_nips34')
        self.dataRec_path = dataRec_path

        self.knowledge_structure = nx.DiGraph()
        with open(f"{get_proj_path()}/data/dataProcess/nips34/nxgraph.pkl", "rb") as file:
        ...
        directory = f'{get_proj_path()}/EduSim/Envs/KES_nips34/meta_data'
