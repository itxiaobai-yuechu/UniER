...
import numpy as np
from EduSim.Envs.KES_assist09.meta.Learner import LearnerGroup, Learner
...
__all__ = ["KESASSIST09Env"]


class KESASSIST09Env(Env):
    def __init__(self, dataRec_path, dataRec_q_path, seed=None):
        ...
        self.KT_model = Agent_KT('assist09', self.num_concepts, 17737, self.learning_item_base ,self.concept_difficulty)
