...
class KESbridge2006Env(Env):
    def __init__(self, dataRec_path, dataRec_q_path, seed=None):
        ...
        self.knowledge_structure_sim = parameters["knowledge_structure_sim"]
        ...
        self.KT_model = Agent_KT('bridge2006', self.num_concepts, 129263, self.learning_item_base ,self.concept_difficulty)
