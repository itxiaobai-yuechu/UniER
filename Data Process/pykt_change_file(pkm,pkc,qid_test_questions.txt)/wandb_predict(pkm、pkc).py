...
def main(params):
    if params['use_wandb'] ==1:
        if not os.environ.get("WANDB_API_KEY"):
            raise RuntimeError("Set WANDB_API_KEY before enabling Weights & Biases logging.")
        import wandb
    ...
    torch.save(stu_ks, os.path.join(save_dir, "ks_top9.pth"))


if __name__ == "__main__":
    save_model_path = 'junyi2015_dkt_qid_saved_model_42_0_0.2_200_0.001_1_1_702d5b07-b755-4b34-a606-5ebf7987bcce'
