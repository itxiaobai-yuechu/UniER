...
def test(args, model, tune_dataset, test_dataset, epoch, target_net, opt, device):
    ...
    tune_batch_loader = data.DataLoader(tune_ERset, batch_size=args.batch_size, shuffle=False, drop_last=True)
    test_batch_loader = data.DataLoader(test_ERset, batch_size=args.batch_size, shuffle=False, drop_last=True)
    print(" fine_tuning")
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--file_dir', type=str, help='data_file_dir', default='datasets/algebra2005')
    ...
    argparser.add_argument('--cuda', type=str, default='cuda:3')
