...
def data_preprocess(args):
    ...
    for id_task in range(len(train_dataset_all)):
        ...
        train_loader_all.append(data.DataLoader(train_ERset, batch_size=args.batch_size, shuffle=False, drop_last=False))
        valid_loader_all.append(data.DataLoader(valid_ERset, batch_size=args.batch_size, shuffle=False, drop_last=False))
