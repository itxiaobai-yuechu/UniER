...
if __name__ == '__main__':
    REL_n = 100
    dataset = 'junyi'
    test_file = f'./datasets/{dataset}/select/test_sequences.csv'
    REL_generator_file = f'./datasets/{dataset}/select/REL_generator_result_{REL_n}.txt'
    Q_matrix = np.load(f'./datasets/{dataset}/select/Q.npy')
